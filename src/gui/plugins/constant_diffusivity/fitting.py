...
from ....utils.defaults import DEFAULTS, THICKNESS_DICT, FLOWRATE_DICT
# from ....models.single_pressure.constant_diffusivity.workflow import data_fitting_workflow
...
class ConstantDiffusivityFitting(ModeFrame):
    ...
    def setup_input_content(self):
        ...
        ctk.CTkLabel(self.input_scroll, 
                    text="Constant Diffusivity Fitting Mode - Coming Soon",
                    text_color="gray").pack(pady=10)
        
        ctk.CTkButton(self.input_scroll,
                     text="Start Fitting (Not Implemented)",
                     state="disabled",
    ...
    def setup_results_content(self):
        ...
        self.results_text = ctk.CTkLabel(self.results_frame, 
                                       text="Fitting results will appear here")
        ...
        self.ax.text(0.5, 0.5, 'Fitting plots will appear here', 
